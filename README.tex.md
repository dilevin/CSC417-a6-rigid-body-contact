...
simulation from the [previous assignment](github.com/dilevin/CSC2549-a5-rigid-bodies) to support contact resolution by solving a Linear Complimentarity Problem.
